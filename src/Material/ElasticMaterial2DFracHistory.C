...
template<>
InputParameters validParams<ElasticMaterial2DFracHistory>()
{
...
ElasticMaterial2DFracHistory::ElasticMaterial2DFracHistory(const InputParameters & parameters) :
...
void
ElasticMaterial2DFracHistory::initQpStatefulProperties()
{
...
void
ElasticMaterial2DFracHistory::computeQpProperties()
{
