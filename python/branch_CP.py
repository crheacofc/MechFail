...
csv_file = pd.read_csv("/home/crhea/Dropbox/Research/Kidney-Stone/sheep/input/static/crackpressure/Branches_CP.csv")
total_gc = []
total_pressure = []
total_values = []
none_gc = []
...
for i in range(len(csv_file)):
    ...
    if csv_file['Number of Branches'][i] == '2' or csv_file['Number of Branches'][i] == '3':
