...
#ifndef OVERISOSTRESS_H
#define OVERISOSTRESS_H
...
class OverIsoStress : public Kernel
{
public:
   ...
   */
  OverIsoStress(const InputParameters & parameters);
...
private:
 ...
 const MaterialProperty<Real> & _overisostress;



};

#endif // OVERISOSTRESS_H
