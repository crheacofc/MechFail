...
/****************************************************************/
#ifndef ACInterfacePraft_H
#define ACInterfacePraft_H

#include "Kernel.h"
#include "JvarMapInterface.h"
#include "DerivativeMaterialInterface.h"

class ACInterfacePraft;

template<>
InputParameters validParams<ACInterfacePraft>();

class ACInterfacePraft : public DerivativeMaterialInterface<JvarMapKernelInterface<Kernel> >
{
public:
  ACInterfacePraft(const InputParameters & parameters);
