...
/****************************************************************/
#ifndef ACInterfaceFracture_H
#define ACInterfaceFracture_H

#include "Kernel.h"
#include "JvarMapInterface.h"
#include "DerivativeMaterialInterface.h"

class ACInterfaceFracture;

template<>
InputParameters validParams<ACInterfaceFracture>();

class ACInterfaceFracture : public DerivativeMaterialInterface<JvarMapKernelInterface<Kernel> >
{
public:
  ACInterfaceFracture(const InputParameters & parameters);
...
protected:
  ...
  const MaterialProperty<RealGradient> & _G_c_grad_old;
  const MaterialProperty<Real> & _dG_cdc_old;
  const MaterialProperty<Real> & _d2G_cdc2_old;
