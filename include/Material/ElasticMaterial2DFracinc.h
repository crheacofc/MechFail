...
#ifndef ElasticMaterial2DFracinc_H
#define ElasticMaterial2DFracinc_H
...
class ElasticMaterial2DFracinc;

template<>
InputParameters validParams<ElasticMaterial2DFracinc>();

/**
 * Praft material class that defines a few properties.
 */
class ElasticMaterial2DFracinc : public DerivativeMaterialInterface<Material>
{
public:
  ElasticMaterial2DFracinc(const InputParameters & parameters);
