...
#ifndef ElasticMaterial2DFracHistory_H
#define ElasticMaterial2DFracHistory_H
...
class ElasticMaterial2DFracHistory;

template <> InputParameters validParams<ElasticMaterial2DFracHistory>();
...
public:
  ElasticMaterial2DFracHistory(const InputParameters &parameters);
