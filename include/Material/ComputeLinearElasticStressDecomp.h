...
/****************************************************************/
#ifndef COMPUTELINEARELASTICSTRESSDECOMP_H
#define COMPUTELINEARELASTICSTRESSDECOMP_H
 ...
 */
class ComputeLinearElasticStressDecomp : public ComputeStressBase
{
public:
  ComputeLinearElasticStressDecomp(const InputParameters & parameters);
...
#endif //COMPUTELINEARELASTICSTRESSDECOMP_H
