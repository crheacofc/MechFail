...
#ifndef PraftMaterial2DExplicit_H
#define PraftMaterial2DExplicit_H
...
class PraftMaterial2DExplicit;
class Function;

template<>
InputParameters validParams<PraftMaterial2DExplicit>();

/**
 * Praft material class that defines a few properties.
 */
class PraftMaterial2DExplicit : public DerivativeMaterialInterface<Material>
{
public:
  PraftMaterial2DExplicit(const InputParameters & parameters);
...
private:
  ...
  */
  ...
  bool _viscosity_set, _L_const_set,  _G_c_const_set, _over_const_set, _diameter_set, _tens_wg_set, _tens_s_set,  _jam_set, _jam_factor_set, _break_set, _irrev_set, _over_type_set, _mobpack_imp_set, _mobpack_fac_set,  _pack_update_set;
  Real _viscosity, _L_const, _G_c_const, _over_const, _diameter, _tens_wg, _tens_s, _jam,_jam_factor, _break;
  int _irrev, _over_type, _mobpack_imp, _mobpack_fac, _pack_update;
  ...
  MaterialProperty<Real> & _dG_cdc_old;
  MaterialProperty<Real> & _d2G_cdc2_old;
...
#endif //PraftMaterial2DExplicit_H
