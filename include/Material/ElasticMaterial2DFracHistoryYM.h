...
#ifndef ElasticMaterial2DFracHistoryYM_H
#define ElasticMaterial2DFracHistoryYM_H
...
class ElasticMaterial2DFracHistoryYM;

template <> InputParameters validParams<ElasticMaterial2DFracHistoryYM>();
...
public:
  ElasticMaterial2DFracHistoryYM(const InputParameters &parameters);
...
private:
  ...
  const VariableValue &_d_history;
...
#endif // ElasticMaterial2DFracHistory_H
